...
function Navbar() {
    ...
    <div className="font-inter text-white flex justify-between flex-row items-center bg-[#1E2B46] lg:px-18 lg:py-8 md:px-15 md:py-6 px-15 sm:py-4">
        ...
        <ul className="flex flex-row lg:gap-20 md:gap-12 sm:gap-8 ">
            <li><a href="/gameknowledge" className="block py-2 hover:text-[#2FD4FF]">Game Knowledge</a></li>
            <li className="relative group">
                <a href="/champion" className="py-2 block hover:text-[#2FD4FF]">Champion</a>
            ...
            <li><a href="/items" className="py-2 block hover:text-[#2FD4FF]">Items</a></li>
        </ul>
